...
void setup()
{
  ...
  lcd.print("T1:");
  //printTemp(0,sensors.getTempCByIndex(0));
  lcd.setCursor(10, 0); // move cursor to column 10, row 0 (first row)
  lcd.print("T2:");
  //printTemp(0,sensors.getTempCByIndex(1));
  lcd.setCursor(0, 3);  // move cursor to column 0, row 3 (last row)
  lcd.print("T3:");
  //printTemp(0,sensors.getTempCByIndex(2));
  lcd.setCursor(10, 3);
  lcd.print("T4:");
  //printTemp(0,sensors.getTempCByIndex(3));
...
void loop()
{
  ...
  if( (now.minute() % 5 == 0) && (p_minute != now.minute()) )
  {   // read & print temperature value from sensor every 30 seconds
